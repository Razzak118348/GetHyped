    ...
    return (
        <div className='mx-6 mt-10 '>
            ...
            <div className='space-y-4 mb-6 ml-0 md:ml-20'>
                <h1 className=" text-2xl md:text-7xl font-bold text-balance md:text-left">Content <br  className='hidden'/> dat scoort.
                </h1>
                <p className='text-md lg:text-2xl text-balance font-bold w-full md:w-2/3 lg:w-1/3'>Wij vertellen jouw verhaal. Op een manier die écht past bij jouw doelgroep. Met creatieve content die werkt en het verschil maakt.</p>
                <motion.button
